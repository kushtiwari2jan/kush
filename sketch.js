...
function preload() {
    ...
    tomImage1=loadanimation("class20/tomone.png");
    tomImage2=loadanimation("class20/tomtwo.png,tomthree.png");
    tomIamge3=loadanimation("class20/tomfour.png");
    jerryImage=loadanimation("class20/jerryone.png,jerrytwo.png,jerrythree.png,jerryfour.png");
